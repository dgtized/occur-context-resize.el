...
Allows dynamic re-sizing the surrounding context in an occur mode buffer. This is similar to the diff resizing in [[https:github.com/magit/magit][magit]]. The following key bindings are enabled:
...
Copyright © 2014 Charles L.G. Comstock
